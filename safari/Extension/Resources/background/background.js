/******/ (() => {
  ...
  /******/ var __webpack_modules__ = [
    ...
    /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      /* harmony import */ var raven_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
      ...
      /* harmony import */ var toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(10);
      /* harmony import */ var toolkit_core_common_storage__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(44);
      /* harmony import */ var toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_3__ =
      ...
      class Background {
        constructor() {
          _defineProperty(
            this,
            '_browser',
            (0, toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_1__.getBrowser)(),
          );
          _defineProperty(
            this,
            '_storage',
            new toolkit_core_common_storage__WEBPACK_IMPORTED_MODULE_2__.ToolkitStorage(),
          );
          ...
          _defineProperty(this, '_checkForUpdates', async () => {
            if (
              (0,
              toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_1__.getBrowserName)() !==
              toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_3__.Browser.Chrome
            ) {
              return;
            }
            const now = Date.now();
          ...
          _defineProperty(this, '_handleException', (context) => {
            raven_js__WEBPACK_IMPORTED_MODULE_0___default().captureException(
              new Error(context.serializedError),
              {
                tags: {
        ...
        initListeners() {
          ...
          if (
            !(0,
            toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_1__.isSafariBrowser)() &&
        ...
        _initializeSentry() {
          const environment = (0,
          toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_1__.getEnvironment)();
          const context = {
            environment,
            release: this._browser.runtime.getManifest().version,
          };
          if (environment !== 'development') {
            raven_js__WEBPACK_IMPORTED_MODULE_0___default()
              .config('https://119c2693bc2a4ed18052ef40ce4adc3c@sentry.io/1218490', context)
              .install();
            raven_js__WEBPACK_IMPORTED_MODULE_0___default().setExtraContext(context);
          }
        }
      }
    ...
    /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      var RavenConstructor = __webpack_require__(3);
    ...
    /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      var TraceKit = __webpack_require__(4);
      ...
      Raven.prototype = {
        ...
        _isRepeatData: function (current) {
          ...
          if (current.stacktrace || last.stacktrace) {
            ...
            return (
              Boolean(current.fingerprint && last.fingerprint) &&
