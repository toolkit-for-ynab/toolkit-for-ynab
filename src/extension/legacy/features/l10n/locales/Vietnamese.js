...
ynabToolKit.l10nData = {
  "toolkit.selectedTotal": "Tổng số được lựa chọn giao dịch",
  "toolkit.balanceToZero": "Cân bằng để 0,00:",
  "toolkit.collapse": "Thu lại",
  "toolkit.DoB": "Ngày của bộ đệm",
  "toolkit.search": "Tìm kiếm:",
  "toolkit.pacing": "Nhịp độ",
  "toolkit.toggleSplits": "Bật lên Phần tách",
  "toolkit.dayOfWeekSu": "Cn",
  "toolkit.dayOfWeekMo": "T2",
  "toolkit.dayOfWeekTu": "T3",
  "toolkit.dayOfWeekWe": "T4",
  "toolkit.dayOfWeekTh": "T5",
  "toolkit.dayOfWeekFr": "T6",
  "toolkit.dayOfWeekSa": "T7",
  "toolkit.myAccount": "Tài khoản của tôi",
  "toolkit.red": "Đỏ",
  "toolkit.orange": "Cam",
  "toolkit.yellow": "Vàng",
  "toolkit.green": "Xanh lá",
  "toolkit.blue": "Xanh dương",
  "toolkit.purple": "Tím",
  "toolkit.creditCardPayments": "Thanh toán thẻ tín dụng",
  "toolkit.transfer": "Đi chuyển đến/từ tài khoản",
  "toolkit.memorized": "Ghi nhớ",
  "toolkit.inflow": "Thu",
  "toolkit.startingBalance": "Số dư ban đầu",
  "toolkit.inflowTBB": "Dòng chảy: Để được ngân sách",
  "toolkit.splitMultipleCategories": "Phân nhỏ (nhiều danh mục)...",
  "toolkit.netWorthReport": "Mạng lưới Có phẩm cách báo cáo",
  "toolkit.netWorth": "Mạng Có phẩm cách ",
  "toolkit.filters": "Bộ lọc",
  "toolkit.timeframe": "Khung thời gian",
  "toolkit.debts": "Khoản nợ",
  "toolkit.assets": "Tài sản",
  "toolkit.incomeFrom": "Thu nhập từ",
  "toolkit.accountsClearSelection": "Thông thoáng lựa chọn",
  "app.done": "Xong",
  ...
  "app.why": "Tại sao",
  "app.for": "{{field}} cho {{institution}}",
  "app.recategorize": "Phân loại lại",
  "app.refresh_now": "Làm mới bây giờ",
  "app.nothing": "Không có gì",
  "app.noThanks": "Không, cảm ơn",
  "loading.loading": "Đang tải {{{item}}}",
  "loading.reticulatingSplines": "Kiểm tra lại lún xuống...",
  "loading.countingMoney": "Đếm tiền...",
  "loading.watchingWhiteboardWednesday": "Coi chừng Bảng trắng Thứ tư...",
  "loading.cuttingJessesHair": "Cắt tóc của jesse...",
  "loading.doing20Burpees": "Đang làm 20 Burpees...",
  "loading.buildingAComplicatedSpreadsheet": "Xây dựng bảng tính phức tạp...",
  "loading.kittenPics": "Nhìn vào hình ảnh của mèo con...",
  "loading.makingSammy": "Làm bánh sandwich...",
  "loading.hitchhiker": "Trả lời câu hỏi cuối cùng...",
  "loading.yakShaving": "Thịt bò cạo râu...",
  "loading.upToEleven": "Biến nó thành 11...",
  "loading.backToFuture": "Tăng tốc đến 88 MPH...",
  "loading.mordor": "Phá hủy một chiếc nhẫn...",
  "loading.theDoctor": "Khóa lại TARDIS...",
  "loading.renderingTransactions": "Làm trở nên giao dịch...",
  "loading.coloringBalances": "Màu thể loại số dư...",
  "loading.hackTubes": "Thuê ống...",
  "loading.kraken": "Giải phóng Krakens...",
  "loading.injectingTooltips": "Tiêm chích công cụ dí dỏm...",
  "loading.ladenSwallows": "Tính vận tốc không lưu của Swallows...",
  "loading.hamsters": "Quay bánh xe Hamster...",
  "loading.pixels": "Tạo kiểu tóc...",
  "loading.activatingActivity": "Kích hoạt hoạt động...",
  "loading.populatingBudget": "Nạp ngân sách...",
  "months.Jan": "Th 1",
  "months.Feb": "Th 2",
  "months.Mar": "Th 3",
  "months.Apr": "Th 4",
  ...
  "error.user_password_invalid": "Mật khẩu không chính xác.",
  "error.user_not_found": "Chúng tôi không thể tìm thấy một tài khoản với email đó. Nếu bạn là người dùng YNAB 4,<a href=\"/launch\">bạn sẽ cần phải đăng ký một tài khoản mới.</a>",
  "error.password_does_not_match": "Mật khẩu xác nhận không trùng khớp.",
  "error.alreadyVerified": "Email đó đã được xác minh.",
  "error.couldNotVerify": "Không thể xác minh tài khoản của bạn. Vui lòng thử lại.",
  "error.resetTokenInvalid": "Mã lấy lại mật khẩu của bạn không hợp lệ.",
  "error.invalidEmail": "Nhập một địa chỉ email hợp lệ.",
  "error.invalidPassword": "Nhập mật khẩu của bạn.",
  "error.shortPassword": "Nhập mật khẩu dài hơn.",
  "modal.categories": "Danh mục ngân sách",
  "modal.noCategoriesFound": "Không tìm thấy danh mục nào.",
  "modal.payees": "Người nhận thanh toán",
  "modal.editPayees": "Chỉnh sửa người nhận thanh toán",
  ...
  "modal.editAccount": "Sửa tài khoản",
  "modal.deleteAccount": "Xoá tài khoản",
  "modal.delete": "Xóa",
  "modal.closeAccount": "Đóng tài khoản",
  "modal.reopenAccount": "Mở lại",
  "modal.createANewAccount": "Thêm một tài khoản mới",
  "modal.selectAnAccountType": "Chọn loại tài khoản...",
  "modal.directConnectInfo": "Nhập vào YNAB là <em>luôn</em>tùy chọn cho dù bạn sử dụng kết nối trực tiếp hay không. Nếu bạn không muốn sử dụng kết nối trực tiếp, bạn vẫn có thể tải xuống và nhập các tệp OFX, QFX và CSV từ ngân hàng của bạn.",
  "modal.managePayees": "Quản Lý Người Thụ Hưởng",
  "modal.noMemorizedPayeesFound": "Không có người nhận thanh toán nào được ghi nhớ.",
  "modal.budgetSettings": "Thiết lập ngân sách",
  "modal.createANewBudget": "Tạo một ngân sách mới",
  "modal.creatingBudget": "Đang tạo ngân sách...",
  "modal.openABudget": "Mở ngân sách",
  "modal.saveACopy": "Lưu một bản sao",
  "modal.makeAFreshStart": "Làm một khởi Đầu mới",
  "modal.makeAFreshStartInfo": "Bắt đầu tươi sẽ cho bạn bắt đầu từ ngân sách ngày hôm nay mà không cần phải thiết lập một nhãn hiệu mới ngân sách. Giao dịch và sở dữ liệu bạn đã nhập vào trong ngân sách của bạn sẽ được xóa nhưng tài khoản giao dịch dự kiến và các loại ngân sách sẽ được lưu lại.",
  ...
  "modal.exportBudgetData": "Xuất dữ liệu ngân sách",
  ...
  "modal.dontRemindMe": "Không hỏi lại",
  "modal.preferences": "Tùy chỉnh",
  "modal.yourAccount": "Tài khoản của bạn",
  "modal.reportAnIssue": "Nhờ trợ giúp",
  "modal.reportAnIssuePrompt": "Bạn tìm thấy lỗi? Bạn muốn phản hồi hoặc muốn đặt câu hỏi? Cứ tự nhiên đi nào!",
  "modal.help": "Trợ giúp!",
  "modal.ynabApps": "Ứng dụng YNAB",
  "modal.signOut": "Đăng xuất",
  ...
  "modal.liveClasses": "Các lớp học trực tiếp",
  ...
  "modal.deleteCategory": "Xóa danh mục",
  "modal.recategorizeTransactionAs": "Phân loại các giao dịch vào danh mục:",
  "modal.beforeYouCanDeleteThisCategory.one": "Trước khi bạn xoá danh mục này, bạn cần phải gán lại {{count}} giao dịch hiện đang được gán cho nó sang danh mục mới. Hãy chọn một danh mục mới dưới đây.",
  "modal.beforeYouCanDeleteThisCategory.other": "Trước khi bạn có thể xóa mục này, bạn cần phải sắp xếp lại các {{count}} giao dịch đó hiện đang được gán cho nó. Chọn một thể loại mới dưới đây.",
  "modal.transactionsHaveBeenRecategorizedAs": "{{count}} giao dịch đã phải tái phân loại như {{category}}.",
  "modal.finishDeletingCategory": "Kết thúc xóa mục",
  "modal.whoaThere": "Whoa đó!",
  "modal.continueEditing": "Tiếp tục chỉnh sửa",
  "modal.areYouSure": "Bạn có chắc không?",
  "modal.deleteReconciledTransaction": "Xóa một sự giao dịch, sẽ mang lại hòa giải mất cân bằng.",
  "modal.deleteTransaction": "Xóa giao dịch",
  "modal.userGuides": "Hướng dẫn sử dụng",
  ...
  "modal.matchedTransaction.category": "Danh mục",
  ...
  "modal.addAccount.txnImport": "Giao Dịch Nhập Khẩu",
  "modal.addAccount.instSearch": "tìm kiếm của ngân hàng của tên",
  "modal.addAccount.popularOptions": "Phổ Biến Lựa Chọn",
  "modal.addAccount.whoWeFound": "Đây là người mà chúng ta tìm thấy",
  "modal.addAccount.noResults": "Chúng tôi không tìm kiếm một ngân hàng tên là \"{{query}}\" đó là sẵn sàng cho kết nối trực tiếp. Không phải lo lắng. YNAB hoạt động như một nhà vô địch với tài khoản mà đừng kết nối trực tiếp với các ngân hàng.",
  "modal.addAccount.noResultsAddManually": "Làm tiếp với một sổ tay tài khoản",
  "modal.addAccount.fetchingInstitutions": "Lấy các tổ chức danh sách...",
  "modal.addAccount.multipleAccounts": "Có rất nhiều tài khoản có sẵn. Chọn một trong các bạn muốn sử dụng",
  "modal.addAccount.examples": "Ví dụ",
  "modal.addAccount.connectSecurely": "Kết nối sự an ninh",
  "modal.addAccount.authenticate": "Chứng thực",
  "modal.addAccount.connectingTo": "Kết nối đến {{name}}...",
  "modal.addAccount.enterYour": "nhập {{value}} của bạn",
  "modal.addAccount.gettingAuthForm": "Nhận được xác nhận từ dữ liệu.",
  "modal.addAccount.alreadyConnected": "đã kết nối với một tài khoản khác",
  "modal.addAccount.mightTake": "Cái nầy có lẽ mất một vài giây.",
  "modal.addAccount.downloading": "Tải Dữ Liệu Tài Khoản...",
  ...
  "modal.addAccount.retry_error": "Xin vui lòng thử lại sau vài phút.",
  ...
  "modal.addAccount.success": "Kết nối thành công!",
  ...
  "feedback.selectATopic": "Chọn một chủ đề",
  "feedback.whatCanWeHelpYouWith": "What can we help you with?",
  "feedback.aTopicIsRequired": "Vui lòng nhập chủ đề.",
  "feedback.aMessageIsRequired": "Vui lòng nhập nội dung.",
  "feedback.beacon-di": "Tôi đang gặp sự cố khi kết nối với ngân hàng của mình",
  "feedback.beacon-migration": "Di chuyển ngân sách của tôi từ YNAB 4",
  "feedback.beacon-switch": "Chuyển sang YNAB mới và đặt giá",
  "feedback.beacon-uscan": "Kết nối với ngân hàng không phải của Hoa Kỳ / Canada",
  "feedback.beacon-feedback": "Thông tin phản hồi hoặc yêu cầu tính năng mới",
  "feedback.beacon-bug": "Tôi nghĩ rằng tôi tìm thấy một lỗi",
  "feedback.beacon-other": "Khác",
  ...
  "accountSettings.accountNameLabel": "Tên tài khoản:",
  "accountSettings.noteLabel": "Lưu ý:",
  "accountSettings.accountTypeLabel": "Loại tài khoản:",
  "accountSettings.accountBalanceLabel": "Số dư hôm nay:",
  ...
  "accountTypes.MerchantAccount": "Thương gia Bản kê",
  "accountTypes.InvestmentAccount": "Tài khoản đầu tư",
  "accountTypes.Mortgage": "Thế chấp",
  "accountTypes.OtherAsset": "Tài sản khác",
  "accountTypes.OtherLiability": "Trách nhiệm pháp lý khác",
  ...
  "budgetCategory.categoryType": "Loại danh mục:",
  ...
  "onboarding.budget-your-money": "Lập ngân sách cho tiền của bạn",
  "onboarding.make-manage-transactions": "Thực hiện và quản lý giao dịch",
  "onboarding.readAGuide": "Đọc hướng dẫn",
  "onboarding.checkTheHandbook": "Check the handbook",
  "onboarding.watchAVideo": "Xem video",
  "onboarding.loadTheNextList": "Load the next list",
  "onboarding.group100-get-started": "Bắt đầu",
  ...
  "onboarding.step300-personalize-your-categories": "Cá nhân hóa danh mục của bạn",
  ...
  "onboarding.step100-add-your-savings-account": "Thêm tài khoản tiết kiệm của bạn",
  ...
  "onboarding.step200-add-your-credit-card-accounts": "Thêm tài khoản thẻ tín dụng của bạn",
  ...
  "onboarding.step100-record-spending": "Ghi nhận chi tiêu",
  ...
  "onboarding.step300-enter-new-income": "Nhập thu nhập mới",
  ...
  "onboarding.step500-make-a-credit-card-payment": "Thanh toán thẻ tín dụng",
  ...
  "dashboard.needSomeHelp": "Cần trợ giúp?",
  "dashboard.startAHelpSession": "Start a help session",
  "dashboard.wantToLearnMore": "Bạn muốn tìm hiểu thêm?",
  "dashboard.viewAllUserGuides": "Xem tất cả các hướng dẫn sử dụng",
  "dashboard.signUpForAClass": "Đăng ký lớp học",
  ...
  "login.dontHaveAnAccount": "Bạn không có tài khoản?",
  "login.rememberMe": "Lưu lại trạng thái đăng nhập trên máy tính này",
  "login.forgotMyPassword": "Tôi quên mật khẩu của tôi",
  "login.forgotYourPassword": "Bạn quên mật khẩu?",
  ...
  "login.passwordReset": "Mật khẩu của bạn đã được đặt lại.",
  "login.saveNewPassword": "Save New Password",
  "login.returnToSignIn": "Return to sign in",
  "login.signUpToday": "Đăng ký ngay hôm nay.",
  ...
  "login.passwordTip": "<strong>Mật khẩu mẹo:</strong> Tạo mật khẩu sử dụng bốn từ ngẫu nhiên. Thật dễ dàng để nhớ, nhưng khó để theo dõi.",
  "login.emailAddress": "Địa chỉ email",
  "login.emailAddressPlaceholder": "địa chỉ email",
  ...
  "login.creatingYourAccount": "Đang tạo tài khoản của bạn...",
  "login.thanksForChoosingYNAB": "Cảm ơn bạn đã lựa chọn YNAB!",
  "login.userHasBeenVerified": "<strong>{{username}}</strong> đã được xác minh.",
  "login.verificationEmailSent": "Email chứa thông tin xác nhận đã được gửi đến <strong>{{username}}</strong>.",
  "login.couponTrialExtended": "Bạn đã nhận được một khuyến mãi đặc biệt: Thời gian dùng thử của bạn đã được gia hạn thêm. Chúc vui vẻ!",
  ...
  "signUp.invitationCode": "Mã thư mời",
  "signUp.invitationCodePlaceholder": "mã thư mời",
  "verify.verifyYourAccount": "Xác minh tài khoản của bạn",
  "verify.sendVerificationEmail": "Gửi email xác minh",
  ...
  "inspector.ccNoBalance": "Cảm giác không còn nợ nần thật tuyệt!",
  ...
  "inspector.createGoal": "Đặt mục tiêu",
  ...
  "accounts.categorizeAs": "Phân loại vào",
  ...
  "accounts.hiddenTxnsButtonText": "Hiển thị giao dịch bị ẩn.",
  ...
  "accounts.notification.haveAnError.one": "{{{error}}} có lỗi.",
  "accounts.notification.haveAnError.other": "{{{error}}} có lỗi.",
  ...
  "accountsHideColumns.memo": "Ghi chú",
  "device.tryManagingYourBudget": "Try managing your budget with your ",
  "welcome.thanksForChoosingYNAB": "Cảm ơn bạn đã lựa chọn YNAB!",
