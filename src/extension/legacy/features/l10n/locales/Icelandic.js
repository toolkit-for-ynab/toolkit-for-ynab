...
ynabToolKit.l10nData = {
  ...
  "app.next": "Næsta",
  "app.complete": "Búið",
  "app.refresh": "Endurhlaða",
  "app.skip": "Sleppa",
  "app.saveAndNext": "Vista og halda áfram",
  "app.undo": "Afturkalla",
  "app.redo": "Endurgera",
  "app.remove": "Fjarlægja",
  "app.makeRepeating": "Endurtekning",
  "app.export": "Flytja út",
  "app.retry": "Reyna aftur",
  ...
  "aria.selectName": "Velja {{name}}",
  "aria.uncheckAll": "Afmerkja allt",
  "loading.loading": "Hleð {{{item}}}",
  "loading.YNAB": "Hleð YNAB",
  "months.Jan": "Jan",
  "months.Feb": "Feb",
  "months.Mar": "Mar",
  "months.Apr": "Apr",
  ...
  "modal.payees.hasMore": "Haltu innslætti áfram til að birta fleiri vistaða viðtakendur.",
  "modal.payees.emptySavedPayees": "Sláðu inn texta til að bæta inn viðtakanda.",
  "modal.payees.oneMatchingPayeeIsHidden": "1 viðtakandi sem passar við skilyrði er falinn",
  "modal.payees.payeeWillBeCreated": "Viðtakandinn \"{{payee}}\" verður búinn til",
  "modal.payees.createPayee": "Búa til viðtakandann \"{{payee}}\"",
  "modal.payees.bankImportDetails": "Bankainnflutningsupplýsingar",
  "modal.payees.asItAppearsLabel": "Eins og það birtist á reikningnum þínum",
  "modal.addCategory": "Bæta við flokk",
  "modal.split": "Skipta (í marga flokka)",
  "modal.accounts": "Reikningar",
  "modal.paymentOrTransfer": "Greiðsla eða millifærsla",
  "modal.budgetAccounts": "Áætlunarreikningar",
  "modal.debtAccounts": "Debt Accounts",
  "modal.trackingAccounts": "Eftirlitsreikningar",
  ...
  "modal.displayTheme": "Birtingarþema",
  "modal.displayOptions": "Display Options",
  "modal.newBudget": "Ný fjárhagsáætlun",
  "modal.creatingBudget": "Bý til áætlun...",
  "modal.openBudget": "Opna áætlun",
  "modal.managePayees": "Sýsla með viðtakendur",
  "modal.manageConnections": "Sýsla með tengingar",
  "modal.saveACopy": "Vista eintak",
  "modal.makeAFreshStart": "Byrja aftur frá grunni",
