...
ynabToolKit.l10nData = {
  ...
  "modal.beforeYouCanDeleteThisCategory.one": "قبل أن تحذف هذه الفئة، سوف تحتاج إلى إعادة تعيين الحركة {{count}} التي تم تعيينها حاليا. حدد فئة جديدة أدناه.",
  "modal.beforeYouCanDeleteThisCategory.other": "قبل أن تحذف هذه الفئة، سوف تحتاج إلى إعادة تعيين الحركة {{count}} التي تم تعيينها حاليا. حدد فئة جديدة أدناه.",
  ...
  "accountSettings.accountBalanceLabel": "حساب اليوم:",
  ...
  "accountTypes.OtherLiability": "مسؤولية أخرى",
  ...
  "onboarding.step400-sign-into-ynab-on-mobile": "تسجيل الدخول إلى يناب على الجهاز المحمول الخاص بك",
  ...
  "onboarding.congratulationsYouveLearnedTheBasicsOfYNAB": "لقد فعلتها! استمر في التركيز على أولوياتك وقم بانشاء ميزانية! <br/> <br/> من الآن فصاعدا، تريد أن تفتح أحدث ميزانية عند تسجيل الدخول؟ يمكنك تغيير هذا في أي وقت في إعدادات الحساب.",
  ...
  "login.returnToSignIn": "العودة إلى تسجيل الدخول",
  ...
  "login.userCreated": "تم إنشاء الحساب. الرجاء تسجيل الدخول.",
