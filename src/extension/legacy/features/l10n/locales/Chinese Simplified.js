...
ynabToolKit.l10nData = {
  ...
  "modal.beforeYouCanDeleteThisCategory.one": "在您可以删除此类别之前, 您需要重新分配目前分配给它的{{count}} 交易。请在下面选择一个新类别。",
  "modal.beforeYouCanDeleteThisCategory.other": "在您可以删除此类别之前, 您需要重新分配目前分配给它的{{count}} 交易。请在下面选择一个新类别。",
  ...
  "accountSettings.accountBalanceLabel": "今天的余额:",
