...
ynabToolKit.l10nData = {
  "toolkit.selectedTotal": "Всього у вибраних транзакціях",
  "toolkit.balanceToZero": "Збалансувати до 0.00:",
  "toolkit.collapse": "Згорнути",
  "toolkit.DoB": "Днів у буфері",
  "toolkit.search": "Пошук:",
  "toolkit.pacing": "Темп",
  "toolkit.toggleSplits": "Згорнути розділені",
  "toolkit.dayOfWeekSu": "Нд",
  ...
  "toolkit.myAccount": "Мій обліковий запис",
  "toolkit.red": "Червоний",
  "toolkit.orange": "Помаранчевий",
  "toolkit.yellow": "Жовтий",
  "toolkit.green": "Зелений",
  "toolkit.blue": "Cиній",
  "toolkit.purple": "Фіолетовий",
  "toolkit.creditCardPayments": "Платежі за кредитними картками",
  "toolkit.transfer": "Переказати до/з рахунку",
  "toolkit.memorized": "Запам'ятовано",
  "toolkit.inflow": "Дохід",
  "toolkit.startingBalance": "Початковий баланс",
  "toolkit.inflowTBB": "Дохід: для бюджетування",
  "toolkit.splitMultipleCategories": "Розділити (кілька категорій)...",
  "toolkit.netWorthReport": "Активи мінус борги - звіт",
  "toolkit.netWorth": "Активи мінус борги ",
  "toolkit.filters": "Фільтри",
  "toolkit.timeframe": "Часові рамки",
  "toolkit.debts": "Борги",
  "toolkit.assets": "Активи",
  "toolkit.incomeFrom": "Дохід від",
  "toolkit.accountsClearSelection": "Очистити вибране",
  "app.done": "Готово",
  ...
  "app.recategorize": "Змінити категорію",
  "app.refresh_now": "Оновити",
  "app.nothing": "Нічого",
  ...
  "error.invalidPassword": "Будь ласка, введіть Ваш пароль.",
  ...
  "modal.editAccount": "Редагувати обліковий запис",
  ...
  "modal.createANewBudget": "Створити новий бюджет",
  "modal.creatingBudget": "Створення бюджету...",
  "modal.openABudget": "Відкрити бюджет",
  "modal.saveACopy": "Зберегти копію",
  "modal.makeAFreshStart": "Make a Fresh Start",
  "modal.makeAFreshStartInfo": "Якщо почати все спочатку, ви зможете приступити до бюджетування з сьогоднішнього дня, без необхідності створення зовсім нового бюджету. Транзакції та інші введені дані будуть видалені, але рахунки, заплановані транзакції та бюджетні категорії збережуться.",
  ...
  "modal.exportBudgetData": "Експорт даних бюджету",
  ...
  "modal.dontRemindMe": "Не нагадувати",
  "modal.preferences": "Налаштування",
  "modal.yourAccount": "Ваш обліковий запис",
  "modal.reportAnIssue": "Отримати допомогу",
  "modal.reportAnIssuePrompt": "Знайшли помилку? Є коментарі чи питання? Зв'яжіться з нами!",
  "modal.help": "Допомога!",
  "modal.ynabApps": "YNAB програми",
  "modal.signOut": "Вийти",
  ...
  "modal.liveClasses": "Уроки наживо (англ.)",
  ...
  "modal.deleteCategory": "Видалити категорію",
  "modal.recategorizeTransactionAs": "Змінити категорію транзакцій на:",
  "modal.beforeYouCanDeleteThisCategory.one": "Перед тим як видалити цю категорію, ви повинні перенести {{count}} транзакцію у іншу категорію. Виберіть нижче.",
  "modal.beforeYouCanDeleteThisCategory.other": "Перед тим як видалити цю категорію, ви повинні перенести {{count}} транзакцій у іншу категорію. Виберіть нижче.",
  "modal.transactionsHaveBeenRecategorizedAs": "{{count}} транзакцій було категоризовано як {{category}}.",
  "modal.finishDeletingCategory": "Завершити видалення категорії",
  "modal.whoaThere": "Упс!",
  "modal.continueEditing": "Продовжити редагування",
  "modal.areYouSure": "Ви впевнені?",
  "modal.deleteReconciledTransaction": "Deleting a reconciled transaction will bring the reconciliation out of balance.",
  "modal.deleteTransaction": "Видалити транзакцію",
  "modal.userGuides": "Довідка",
  ...
  "modal.matchedTransaction.category": "Категорія",
  ...
  "modal.addAccount.examples": "Приклади",
  "modal.addAccount.connectSecurely": "Connect Securely",
  "modal.addAccount.authenticate": "Автентифікація",
  ...
  "accountSettings.noteLabel": "Примітка:",
  ...
  "onboarding.watchAVideo": "Дивитися відео",
  "onboarding.loadTheNextList": "Завантажити наступний список",
  "onboarding.group100-get-started": "Почати роботу",
  ...
  "login.enterNewPassword": "<strong>Введіть новий пароль</strong><em>-принаймні 8 символів</em>",
