...
ynabToolKit.l10nData = {
  ...
  "app.refresh": "Ricarica",
  "app.skip": "Salta",
  "app.saveAndNext": "Salva e Successivo",
  "app.undo": "Annulla",
  "app.redo": "Ripeti",
  "app.remove": "Rimuovi",
  "app.makeRepeating": "Ripeti",
  "app.export": "Esporta",
  "app.retry": "Riprova",
  "app.youNeedABudget": "Ti Serve un Budget",
  "app.gotIt": "Capito",
  ...
  "aria.selectName": "Seleziona {{name}}",
  "aria.uncheckAll": "Deseleziona tutto",
  "loading.loading": "Caricando {{{item}}}",
  "loading.YNAB": "Caricamento di YNAB",
  "months.Jan": "Gen",
  "months.Feb": "Feb",
  "months.Mar": "Mar",
  "months.Apr": "Apr",
  ...
  "modal.payees.hasMore": "Continua a digitare per visualizzare altri beneficiari salvati.",
  "modal.payees.emptySavedPayees": "Inizia a digitare per aggiungere un beneficiario.",
  "modal.payees.oneMatchingPayeeIsHidden": "1 beneficiario corrispondente è nascosto",
  "modal.payees.payeeWillBeCreated": "\"{{payee}}\" beneficiario sarà creato",
  "modal.payees.createPayee": "Crea \"{{payee}}\" beneficiario",
  "modal.payees.bankImportDetails": "Dettagli di Importazione Banca",
  "modal.payees.asItAppearsLabel": "Come appare sul tuo estratto conto",
  "modal.addCategory": "Aggiungi una categoria",
  "modal.split": "Dividi (più categorie)",
  "modal.accounts": "Conti",
  "modal.paymentOrTransfer": "Pagamento o Trasferimento",
  "modal.budgetAccounts": "Budget dei Conti",
  "modal.debtAccounts": "Debt Accounts",
  "modal.trackingAccounts": "Monitoraggio Conti",
  ...
  "modal.displayTheme": "Mostra Tema",
  "modal.displayOptions": "Display Options",
  "modal.newBudget": "Nuovo Budget",
  "modal.creatingBudget": "Creando un bilancio...",
  "modal.openBudget": "Apri Budget",
  "modal.managePayees": "Gestisci Beneficiari",
  "modal.manageConnections": "Gestisci Connessioni",
  "modal.saveACopy": "Salva una copia",
  "modal.makeAFreshStart": "Fai un Nuovo Inizio",
  ...
  "modal.makeAFreshStart.whatWillGetCopied": "Ecco cosa sarà copiato al tuo nuovo budget di Nuovo inizio:",
  "modal.makeAFreshStart.yourAccounts": "I tuoi conti, inclusi quelli collegati",
  "modal.makeAFreshStart.balances": "Bilanci per conti collegati",
  "modal.makeAFreshStart.todaysTransactions": "Le transazioni di oggi per i conti collegati",
  "modal.makeAFreshStart.scheduledTransactions": "Transazioni pianificate",
  "modal.makeAFreshStart.budgetCategories": "Categorie e scopi del budget",
  "modal.makeAFreshStart.newBudgetName": "Nuovo Nome Bilancio",
  "modal.makeAFreshStart.budgetNameAlreadyExists": "Il nome del bilancio esiste già.",
  "modal.makeAFreshStart.dontWorry": "Non preoccuparti, puoi sempre modificarlo più tardi.",
  ...
  "modal.exportBudget": "Esporta Budget",
  ...
  "sidebar.noAccounts.youCantBudget": "Non puoi fare il budget senza aggiungere prima i conti a YNAB. Che ne pensi di aggiungerne uno ora?",
  "toStartBudgetingAddAnAccount": "Per iniziare il bilancio, aggiungi un conto!",
  ...
  "onboarding3.welcomeToYourNewBudget": "Benvenuto al Tuo Nuovo Budget!",
