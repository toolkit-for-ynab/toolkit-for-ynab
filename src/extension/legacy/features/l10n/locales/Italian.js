...
ynabToolKit.l10nData = {
  "toolkit.selectedTotal": "Totale Transazioni selezionate",
  "toolkit.balanceToZero": "Saldare a 0.00:",
  "toolkit.collapse": "Minimizzare",
  "toolkit.DoB": "Giorni di Buffering",
  "toolkit.search": "Cerca:",
  "toolkit.pacing": "Cadenza",
  "toolkit.toggleSplits": "Attiva/disattiva Divisioni",
  "toolkit.dayOfWeekSu": "Dom",
  "toolkit.dayOfWeekMo": "Lun",
  "toolkit.dayOfWeekTu": "Mar",
  "toolkit.dayOfWeekWe": "Mer",
  "toolkit.dayOfWeekTh": "Gio",
  "toolkit.dayOfWeekFr": "Ven",
  "toolkit.dayOfWeekSa": "Sat",
  "toolkit.myAccount": "Il mio Account",
  "toolkit.red": "Rosso",
  "toolkit.orange": "Arancione",
  "toolkit.yellow": "Giallo",
  "toolkit.green": "Verde",
  "toolkit.blue": "Blu",
  "toolkit.purple": "Viola",
  "toolkit.creditCardPayments": "Pagamenti con carta di credito",
  "toolkit.transfer": "Trasferisci al/dal conto",
  "toolkit.memorized": "Memorizzati",
  "toolkit.inflow": "Entrata",
  "toolkit.startingBalance": "Saldo iniziale",
  "toolkit.inflowTBB": "Entrata: Da mettere a Bilancio",
  "toolkit.splitMultipleCategories": "Dividi (Categorie Multiple)...",
  "toolkit.netWorthReport": "Rapporto patrimonio netto",
  "toolkit.netWorth": "Patrimonio netto ",
  "toolkit.filters": "Filtri",
  "toolkit.timeframe": "Intervallo di tempo",
  "toolkit.debts": "Debiti",
  "toolkit.assets": "Attività",
  "toolkit.incomeFrom": "Reddito da",
  "toolkit.accountsClearSelection": "Cancella selezione",
  "app.done": "Fatto",
  ...
  "app.why": "Perché",
  "app.for": "{{field}} per {{institution}}",
  "app.recategorize": "Ricategorizzare",
  "app.refresh_now": "Aggiorna ora",
  "app.nothing": "Niente",
  "app.noThanks": "No, grazie",
  "loading.loading": "Caricando {{{item}}}",
  "loading.reticulatingSplines": "Reticulating splines...",
  "loading.countingMoney": "Contando i soldi...",
  "loading.watchingWhiteboardWednesday": "Watching Whiteboard Wednesday...",
  "loading.cuttingJessesHair": "Tagliando i capelli a Jesse...",
  "loading.doing20Burpees": "Facendo 20 Flessioni...",
  "loading.buildingAComplicatedSpreadsheet": "Creando uno spreadsheet complicato...",
  "loading.kittenPics": "Guardando immagini di gattini...",
  "loading.makingSammy": "Preparando un panino...",
  "loading.hitchhiker": "Rispondendo alla domanda finale...",
  "loading.yakShaving": "Tosando pecore...",
  "loading.upToEleven": "Alzare ad 11...",
  "loading.backToFuture": "Accellerare a 88 MPH...",
  "loading.mordor": "Distruggendo l'Unico Anello...",
  "loading.theDoctor": "Chiudendo il TARDIS...",
  "loading.renderingTransactions": "Interpretando le transazioni...",
  "loading.coloringBalances": "Colorando le categorie dei saldi...",
  "loading.hackTubes": "Hacking the tubes...",
  "loading.kraken": "Liberando il Kraken...",
  "loading.injectingTooltips": "Injecting witty tooltips...",
  "loading.ladenSwallows": "Calcolando la velocita di una rondine senza peso...",
  "loading.hamsters": "Spinning up Hamster wheels...",
  "loading.pixels": "Stilizzando i pixel...",
  "loading.activatingActivity": "Attivando le attivita...",
  "loading.populatingBudget": "Compilando il bilancio...",
  "months.Jan": "Gen",
  "months.Feb": "Feb",
  "months.Mar": "Mar",
  "months.Apr": "Apr",
  ...
  "error.user_password_invalid": "Password errata.",
  "error.user_not_found": "Non siamo riusciti a trovare un account collegato a questa email. Se sei un utente di YNAB 4, <a href=\"/launch\">devi creare un nuovo account.</a>",
  "error.password_does_not_match": "Le password non corrispondono.",
  "error.alreadyVerified": "Questa email è già stata verificata.",
  "error.couldNotVerify": "Non siamo riusciti a verificare il tuo account. Per favore, prova di nuovo.",
  "error.resetTokenInvalid": "Your reset password token is invalid.",
  "error.invalidEmail": "Inserisci un indirizzo email valido.",
  "error.invalidPassword": "Inserisci la tua password.",
  "error.shortPassword": "Inserisci una password più lunga.",
  "modal.categories": "Categorie del Budget",
  "modal.noCategoriesFound": "Nessuna categoria trovata.",
  "modal.payees": "Beneficiari",
  "modal.editPayees": "Modifica i beneficiari",
  ...
  "modal.editAccount": "Modifica conto",
  "modal.deleteAccount": "Elimina conto",
  "modal.delete": "Cancella",
  "modal.closeAccount": "Chiudi il conto",
  "modal.reopenAccount": "Riapri",
  "modal.createANewAccount": "Aggiungi un nuovo conto",
  "modal.selectAnAccountType": "Seleziona un tipo di conto...",
  "modal.directConnectInfo": "L'importazione in YNAB è <em>sempre</em> facoltativa sia se si utilizza l'importazione diretta o no. Se si preferisce o non si può utilizzare l'importazione diretta, è possibile scaricare e importare i file OFX, QFX e CSV dalla vostra banca.",
  "modal.managePayees": "Manage Payees",
  "modal.noMemorizedPayeesFound": "Nessun beneficiario memorizzato trovato.",
  "modal.budgetSettings": "Impostazioni di bilancio",
  "modal.createANewBudget": "Crea un nuovo bilancio",
  "modal.creatingBudget": "Creando un bilancio...",
  "modal.openABudget": "Apri un bilancio",
  ...
  "modal.exportBudgetData": "Esportare i dati del Budget",
  ...
  "modal.dontRemindMe": "Non ricordarmelo",
  "modal.preferences": "Preferenze",
  "modal.yourAccount": "Il tuo conto",
  "modal.reportAnIssue": "Ottieni aiuto",
  "modal.reportAnIssuePrompt": "Trovato un errore? Hai un feedback o una domanda? Spara!",
  "modal.help": "Aiuto!",
  "modal.ynabApps": "Apps di YNAB",
  "modal.signOut": "Disconnetti",
  ...
  "modal.liveClasses": "Lezioni live",
  ...
  "modal.recategorizeTransactionAs": "Ricategorizzare le transazioni come:",
  "modal.beforeYouCanDeleteThisCategory.one": "Prima di poter eliminare questa categoria, è necessario riassegnare la transazione {{count}} che è attualmente assegnata ad essa. Selezionare una nuova categoria sotto.",
  "modal.beforeYouCanDeleteThisCategory.other": "Prima di poter eliminare questa categoria, è necessario riassegnare le transazioni {{count}} che sono attualmente assegnata ad essa. Selezionare una nuova categoria sotto.",
  "modal.transactionsHaveBeenRecategorizedAs": "{{count}} transazioni sono state ricategorizzate come {{category}}.",
  "modal.finishDeletingCategory": "Completare l'eliminazione della categoria",
  "modal.whoaThere": "Ehilà!",
  "modal.continueEditing": "Continua le modifiche",
  "modal.areYouSure": "Sei sicuro?",
  "modal.deleteReconciledTransaction": "Deleting a reconciled transaction will bring the reconciliation out of balance.",
  "modal.deleteTransaction": "Elimina transazione",
  "modal.userGuides": "Guide utente",
  ...
  "modal.addAccount.txnImport": "Importazione delle Transazioni",
  "modal.addAccount.instSearch": "ricerca il nome della tua banca",
  "modal.addAccount.popularOptions": "Opzioni Popolari",
  "modal.addAccount.whoWeFound": "Ecco quello che abbiamo trovato",
  "modal.addAccount.noResults": "Non siamo riusciti a trovare una banca chiamata \"{{query}}\" disponibile per la connessione diretta. Nessun problema. YNAB funziona alla grande con i conti che non si connettono direttamente alle banche.",
  "modal.addAccount.noResultsAddManually": "Continua con un conto manuale",
  "modal.addAccount.fetchingInstitutions": "Recupero dell'elenco delle istituzioni...",
  "modal.addAccount.multipleAccounts": "There are multiple accounts available. Select the one you'd like to use",
  "modal.addAccount.examples": "Esempi",
  "modal.addAccount.connectSecurely": "Connettersi in modo sicuro",
  "modal.addAccount.authenticate": "Autenticare",
  "modal.addAccount.connectingTo": "Connessione a {{name}}...",
  "modal.addAccount.enterYour": "inserisci il tuo {{value}}",
  ...
  "modal.addAccount.mightTake": "Questa operazione potrebbe richiedere alcuni secondi.",
  "modal.addAccount.downloading": "Scaricando i dati del conto...",
  ...
  "modal.addAccount.mfa_answer_incorrect_error": "La risposta data non è corretta. Si prega di riprovare.",
  ...
  "modal.addAccount.retry_error": "Riprova tra qualche minuto.",
  "modal.addAccount.service_unavailable_error": "Al momento non è disponibile il servizio di importazione diretta. Riprova tra qualche minuto.",
  "modal.addAccount.singleAccountAlreadyConnectedError": "Questo account è già connesso ad un account in YNAB.",
  ...
  "modal.addAccount.success": "Connessione avvenuta con successo!",
  ...
  "feedback.selectATopic": "Seleziona un argomento",
  "feedback.whatCanWeHelpYouWith": "In cosa possiamo aiutarti?",
  "feedback.aTopicIsRequired": "Un argomento è necessario.",
  "feedback.aMessageIsRequired": "Un messaggio è necessario.",
  "feedback.beacon-di": "Sto avendo problemi a connettermi alla mia banca",
  "feedback.beacon-migration": "Trasferire il mio bilancio da YNAB 4",
  "feedback.beacon-switch": "Passare il nuovo YNAB, e prezzi",
  "feedback.beacon-uscan": "Connessione a una banca non USA o Canadese",
  "feedback.beacon-feedback": "Feedback o richieste di nuove funzionalità",
  "feedback.beacon-bug": "Penso di aver trovato un bug",
  "feedback.beacon-other": "Altro",
  ...
  "accountSettings.accountNameLabel": "Nome del conto:",
  "accountSettings.noteLabel": "Nota:",
  "accountSettings.accountTypeLabel": "Tipo di conto:",
  "accountSettings.accountBalanceLabel": "Saldo di oggi:",
  ...
  "accountTypes.InvestmentAccount": "Conto d'investimento",
  "accountTypes.Mortgage": "Mutuo",
  ...
  "budgetCategory.categoryType": "Tipo di categoria:",
  "budgetCategory.goalAmount": "Ammontare Goal:",
  "budgetCategory.dueDate": "Scadenza:",
  "budgetCategory.overspending": "Eccesso di spesa:",
  "budgetCategory.enterBudgetName": "Inserisci il nome del bilancio",
  ...
  "onboarding.step100-sign-up-with-ynab": "Iscriviti con YNAB!",
  ...
  "onboarding.make-manage-transactions": "Crea e gestisci le transazioni",
  "onboarding.readAGuide": "Leggi una guida",
  "onboarding.checkTheHandbook": "Controlla il manuale",
  "onboarding.watchAVideo": "Guarda un video",
  "onboarding.loadTheNextList": "Carica l'elenco successivo",
  "onboarding.group100-get-started": "Inizia",
  "onboarding.group200-budget-your-money": "Budget Your Money",
  "onboarding.group300-stay-on-track": "Rimani in pista",
  "onboarding.createYourFirstBudgetCategories": "Crea le tue prime categorie, preprara i tuoi obiettivi, e dai ad ogni moneta un lavoro.",
  "onboarding.step200-add-primary-spending": "Aggiungi il tuo conto primario",
  "onboarding.setUpYourCheckingOrTransactionAccount": "Set up your checking or transaction account to fund your budget.",
  "onboarding.step300-personalize-your-categories": "Personalizza le tue categorie",
  "onboarding.makeSureYourPrioritiesAreRepresented": "Assicurati che le tue priorità siano ben rappresentate nel bilancio!",
  "onboarding.step400-set-a-goal": "Imposta un obiettivo",
  "onboarding.whatsMostImportantToYou": "What's most important to you?<br/>Plan for it.",
  "onboarding.step500-schedule-a-transaction": "Pianificare una transazione",
  ...
  "onboarding.step100-add-your-savings-account": "Aggiungi il tuo conto di risparmio",
  ...
  "onboarding.givingEveryDollarAJobMeansBudgetingAllTheWayToZero": "Dare un lavoro ad ogni moneta significa mettere il bilancio a zero.",
  ...
  "onboarding.step200-move-money": "Sposta denaro",
  "onboarding.makeChangesWhenYouNeedToYesThatsABudget": "Make changes when you need to. Yes, that's a budget.",
  "onboarding.step300-enter-new-income": "Inserisci una nuova entrata",
  ...
  "onboarding.step400-reconcile": "Contabilizza",
  "onboarding.keepUpToDateSoYouCanAlwaysTrustYourBudget": "Keep up to date so you can always trust your budget.",
  "onboarding.step500-make-a-credit-card-payment": "Effettua un pagamento con carta di credito",
  ...
  "onboarding.budgetingWithAPartnerTakeThisEssentialStep": "Gestisci il Budget con un partner? Procedi con questo passo essenziale.",
  ...
  "onboarding.tasksCompleted": "{{name}} attività completate!",
  "dashboard.needSomeHelp": "Hai bisogno d'aiuto?",
  "dashboard.startAHelpSession": "Avvia una sezione d'aiuto (in inglese)",
  "dashboard.wantToLearnMore": "Vuoi saperne di più?",
  "dashboard.viewAllUserGuides": "Mostra tutte le guide per l'utente",
  "dashboard.signUpForAClass": "Iscriviti ad una lezione",
  ...
  "login.dontHaveAnAccount": "Non hai ancora un account?",
  "login.rememberMe": "Ricordami su questo computer",
  "login.forgotMyPassword": "Ho dimenticato la mia password",
  "login.forgotYourPassword": "Hai dimenticato la password?",
  "login.forgotMessage": "Niente panico. Inserisci l'indirizzo email che hai usato per la registrazione e ti invieremo le istruzioni per reimpostare la password.",
  "login.sendResetInstructions": "Send Reset Instructions",
  "login.passwordReset": "La password è stata reimpostata.",
  "login.saveNewPassword": "Save New Password",
  "login.returnToSignIn": "Return to sign in",
  "login.signUpToday": "Iscriviti oggi.",
  ...
  "login.emailAddressPlaceholder": "indirizzo email",
  ...
  "login.thanksForChoosingYNAB": "Grazie per aver scelto YNAB!",
  ...
  "signUp.invitationCode": "Codice di invito",
  "signUp.invitationCodePlaceholder": "codice di invito",
  "verify.verifyYourAccount": "Verifica il tuo conto",
  "verify.sendVerificationEmail": "Invia email di verifica",
  ...
  "budget.setAsideForNextMonth": "Mettere da parte per il prossimo mese",
  ...
  "inspector.ageOfMoneyProgress": "Progresso Età del Denaro",
  ...
  "inspector.goalTarget": "Obbiettivo Goal",
  "inspector.budgetedPreviousMonth": "Finanziato nel mese scorso",
  "inspector.spentPreviousMonth": "Speso il mese scorso",
  "inspector.paidPreviousMonth": "Pagato il mese scorso",
  "inspector.budgetedAverage": "Finanziato in media",
  "inspector.spentAverage": "Spesa Media",
  "inspector.paidAverage": "Pagato in media",
  "inspector.underfunded": "Sottofinanziato",
  "inspector.leftToBudget": "Da mettere a Bilancio",
  "inspector.fundedLastMonth": "Finanziato nel mese scorso",
  "inspector.averageFunded": "Finanziato in media",
  ...
  "inspector.goals.title": "Obiettivi",
  "inspector.goals.payOffByDate": "Pay Off Balance by Date",
  "inspector.goals.paySpecificAmount": "Paga un importo specifico ogni mese",
  ...
  "inspector.createGoal": "Crea un Obiettivo",
  ...
  "inspector.goalMFWarning": "Sei indietro di {{toGo}} sul tuo obiettivo per questo mese. Finanzia altri {{toGo}} per stare in riga.",
  ...
  "inspector.goalTBMessage": "Se metti a bilancio {{budgeted}} ogni mese, raggiungerai il tuo obiettivo di {{goalTarget}} in {{months}} mesi.",
  ...
  "inspector.cashOverSpending": "In questa categoria hai sforato il budget di <strong>{{overSpentAmount}}</strong>. Copri la spese extra tramite i residui delle altre categorie oppure non potrai fidarti del bilancio!",
  "inspector.creditOverSpending": "In questa categoria hai sforato il budget di <strong>{{overSpentAmount}}</strong> tramite del credito. Copri la spese extra tramite i residui delle altre categorie per evitare di creare debito!",
  ...
  "inspector.noPayee": "nessun beneficiario",
  ...
  "accounts.categorizeAs": "Categorizza come",
  ...
  "accounts.hiddenTxnsButtonText": "Mostra le transazioni nascoste.",
  ...
  "accountsHideColumns.cleared": "Liquidato",
  ...
  "login.userHasBeenConfirmed": "<strong>{{username}}</strong> è stato confermato.",
  ...
  "onboarding.step200-schedule-upcoming-transactions": "Pianifica una transazione futura",
  "onboarding.step300-set-a-goal": "Imposta un obiettivo",
  ...
  "modal.addAccount.genericInstitutionName": "Banca",
  ...
  "users.budgets.lastAccessedOn": "Ultimo accesso {{daysAgo}}",
