import { YNABTransaction as Transaction } from '../../../../../types/ynab/data/transaction';
...
describe('Reconcile Assistant Utils', () => {
  describe('findMatchingSum()', () => {
    ...
    it('should find a single match with single transaction', () => {
      let transactions: Array<Transaction> = [{ amount: 5 } as Transaction];
      ...
      let expected: Array<Array<Transaction>> = [[{ amount: 5 } as Transaction]];
    ...
    it('should find a single match with two transactions', () => {
      ...
      let expected: Array<Array<Transaction>> = [
        [{ amount: 5 } as Transaction, { amount: 10 } as Transaction],
      ];
      expect(results).toEqual(expect.arrayContaining(expected));
    });
    ...
    it('should find inflow + outflow or empty', () => {
      ...
      let expected: Array<Array<Transaction>> = [
        [{ amount: 5 } as Transaction, { amount: -5 } as Transaction],
        [],
      ];
      expect(results).toEqual(expect.arrayContaining(expected));
    });
  ...
  describe('getUnclearedTransactions(transactions)', () => {
    ...
    it('should return only cleared transactions', () => {
      let t1: Transaction = mockTransaction(5, 'Cleared', false) as Transaction;
      let t2: Transaction = mockTransaction(10, 'Uncleared', false) as Transaction;
    ...
    it('should return nothing when there are no cleared transactions', () => {
      let t1: Transaction = mockTransaction(5, 'Cleared', false) as Transaction;
      let t2: Transaction = mockTransaction(10, 'Cleared', false) as Transaction;
      let transactions: Array<Transaction> = [t1, t2];
    ...
    it('should ignore deleted transactions', () => {
      let t1: Transaction = mockTransaction(5, 'Uncleared', false) as Transaction;
      let t2: Transaction = mockTransaction(10, 'Uncleared', true) as Transaction;
      let t3: Transaction = mockTransaction(10, 'Uncleared', false) as Transaction;
