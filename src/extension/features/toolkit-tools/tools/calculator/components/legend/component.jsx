...
import { Currency } from '$tools/common/components/currency';
import './styles.scss';
  ...
  <React.Fragment>
    <div className="tk-mg-05 tk-pd-r-1 tk-border-r">
      <div className="tk-flex tk-mg-b-05 tk-align-items-center">
        ...
        <div className="tk-mg-l-05">Her-Debts</div>
      </div>
      <div>
    ...
    <div className="tk-mg-05 tk-pd-r-1 tk-border-r">
      <div className="tk-flex tk-mg-b-05 tk-align-items-center">
        ...
        <div className="tk-mg-l-05">Her-Assets</div>
      </div>
      <div>
    ...
    <div className="tk-mg-05 tk-pd-r-1">
      <div className="tk-flex tk-mg-b-05 tk-align-items-center">
        ...
        <div className="tk-mg-l-05">Her-Net Worth</div>
      </div>
      <div>
