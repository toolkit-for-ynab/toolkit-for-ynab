...
for dirName, subdirList, fileList in os.walk('./sauce/extension/legacy/features/'):
...
with open('./sauce/extension/legacy/features/act-on-change/feedChanges.js', 'w') as feedChanges:
    feedChanges.write(('/*\n'
                       ' **********************************************************\n'
